        ...
        <div className="flex flex-col gap-6 border-b border-border pb-6 lg:flex-row lg:items-end lg:justify-between">
          <div className="space-y-4">
            ...
            <p className="max-w-3xl text-base leading-8 text-muted">
              Manage duration labels, min/max ticket size, payout, and public visibility from one
              period registry. This keeps the order ticket config path editable before live chart
              streaming lands.
            </p>
          </div>
