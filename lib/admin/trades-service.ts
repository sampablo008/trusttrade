...
const ADMIN_TRADE_SELECT =
  "id, user_id, token_id, period_id, direction, stake_cents, payout_bps, entry_price_cents, strike_price_cents, status, outcome, admin_forced_outcome, started_at, end_time, tokens!token_id(symbol), trade_periods(duration_seconds), profiles!user_trades_user_id_fkey(username, email, created_at)";
