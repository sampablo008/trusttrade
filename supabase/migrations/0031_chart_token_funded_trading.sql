-- ---------------------------------------------------------------------------
-- Switch place_trade to lock from the chart token (not USDT).
-- The USD stake entered by the user is converted to chart-token units at the
-- current token price. settle_trade already handles per-token credits via
-- lock_token_id, so no changes are needed there.
-- ---------------------------------------------------------------------------
